...
class GenerationMixin:
    ...
    def _update_model_kwargs_for_generation(
        ...
        if "token_type_ids" in model_kwargs:
            print("token_type_ids activated")
    ...
    def generate(
        ...
        code2_decoding: Optional[bool] = None,
        ...
        **kwargs,
        ...
        # input(kwargs)
        # input(inputs)
        # print("code2_kwargs", code2_kwargs)
        # input()
        ...
        print("code2_decoding", code2_decoding)
        ...
        if code2_decoding:
            ...
            return self.code2_greedy_decode(
                input_ids,
                logits_processor=logits_processor,
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if word_complete:
                ...
                save_intermediates = {"input_ids": input_ids, "model_kwargs":model_kwargs, "scores": scores, 
            ...
            if last_word_flag == False:
                ...
                print("\nif embeds_list[0]==embeds_list[1]", are_equal)
                clock_logits_list = []
                ...
                print("contrast word 1: ", last_word)
                # intermediate_token_lists = input_ids
    ...
    #     return next_token_logits #probs #final_logits
