...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if halc_decoding and dola_decoding and beam_search==True:
            if generation_config.num_return_sequences > 1:
                raise ValueError(
                    f"num_return_sequences has to be 1, but is {generation_config.num_return_sequences} when doing"
                    " greedy search."
        ...
        if halc_decoding and not dola_decoding and beam_search==False:
            if generation_config.num_return_sequences > 1:
                raise ValueError(
                    f"num_return_sequences has to be 1, but is {generation_config.num_return_sequences} when doing"
                    " greedy search."
        ...
        if is_greedy_gen_mode and dola_decoding and beam_search==False:
            if generation_config.num_return_sequences > 1:
                raise ValueError(
                    f"num_return_sequences has to be 1, but is {generation_config.num_return_sequences} when doing"
                    " greedy search."
