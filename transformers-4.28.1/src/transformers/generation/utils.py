...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        elif halc_decoding and not dola_decoding and beam_search==False:
            if generation_config.num_return_sequences > 1:
                raise ValueError(
                    f"num_return_sequences has to be 1, but is {generation_config.num_return_sequences} when doing"
                    " greedy search."
        ...
        elif beam_search==True and opera_decoding:
            assert generation_config.output_attentions, "OPERA decoding requires output_attentions=True!"
        ...
        elif is_greedy_gen_mode and contrastive_decoding:
            if generation_config.num_return_sequences > 1:
                raise ValueError(
                    f"num_return_sequences has to be 1, but is {generation_config.num_return_sequences} when doing"
                    " greedy search."
